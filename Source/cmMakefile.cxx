    ...
    if(pcmd->GetEnabled() && !cmSystemTools::GetFatalErrorOccured()  &&
      ...
      if(!pcmd->InvokeInitialPass(lff.Arguments,status) ||
        ...
        if (this->GetCMakeInstance()->GetWorkingMode() != cmake::NORMAL_MODE
            && this->GetCMakeInstance()->GetWorkingMode() != cmake::SNAPSHOT_RECORD_MODE)
          {
                                   ...
                                   const cmPolicies::PolicyMap& pm)
{
  this->StateSnapshot =
      this->GetState()->CreateFunctionCallSnapshot(
        ...
        functionContext, functionEndLine);
...
cmMakefile::ReadCommands(std::vector<cmListFileFunction> const& commands,
                   long fileLine)
{
  cmState::Snapshot snp = this->StateSnapshot;
