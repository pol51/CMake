...
cmFindPackageCommand::GetContextForParameter(const std::vector<std::string>& args,
                                             size_t index)
{
  if (index == 0)
    {
...
cmFindPackageCommand::GetKeywords(const std::vector<std::string>& args, size_t index)
{
  (void)args;
...
//----------------------------------------------------------------------------
bool cmFindPackageCommand
::DoInitialPass(std::vector<std::string> const& args)
{
  if(args.size() < 1)
    {
