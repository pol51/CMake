...
public:
  ...
  Json::Value Complete(cmState::Snapshot snp,
...
private:
  ...
  Json::Value CodeCompleteCommand(cmState::Snapshot snp,
                           std::string matcher);

  Json::Value CodeCompleteParameter(cmState::Snapshot snp, cmListFileFunction* fn,
                             long fileLine, long fileColumn);
